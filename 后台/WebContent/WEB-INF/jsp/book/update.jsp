...
<body>
      ...
      <div class="main_container" id="forms_page">
        <div class="row-fluid">
          <ul class="breadcrumb">
            ...
            <li><a href="#">课程修改</a> <span class="divider">/</span></li>
            <li class="active">
            	<c:if test="${type==1}">修改课程</c:if>
            	<c:if test="${type==2}">修改学期</c:if>
            	<c:if test="${type==3}">修改章节</c:if>
            	<c:if test="${type==4}">修改小节</c:if>
            </li>
          </ul>
          <h2 class="heading">修改</h2>
        </div>
        <div class="row-fluid">
          <div class="widget widget-padding span12">
            <div class="widget-header">
           	  <c:if test="${type==1}"><i class="icon-table"></i><h5>旧的课程</h5></c:if>
         	  <c:if test="${type==2}"><i class="icon-th-large"></i><h5>旧的学期</h5></c:if>
         	  <c:if test="${type==3}"><i class="icon-th"></i><h5>旧的章节</h5></c:if>
         	  <c:if test="${type==4}"><i class="icon-th-list"></i><h5>旧的小节</h5></c:if>
            </div>
                <!-- 修改课程 -->
                <c:if test="${type==1}">
                	<form class="form-horizontal" action="book/update">
                	<div class="widget-body">
              		 <div class="widget-forms clearfix">
	                  <div class="control-group">
	                    <label class="control-label">课程名</label>
	                    <div class="controls">
	                      <input class="span5" type="text" name="NAME" value="${course.NAME}" placeholder="50字以内…">
                ...
                <c:if test="${type==2}">
	                  ...
	                  <div class="control-group">
	                    ...
	                    <div class="controls">
	                      <input class="span5" type="text" name="NAME" value="${phase.NAME}" placeholder="50字以内…">
                ...
                <c:if test="${type==3}">
                	...
                	<div class="widget-body">
	                  ...
	                  <div class="control-group">
	                    ...
	                    <div class="controls">
	                      <input class="span5" type="text" name="NAME" value="${chapter1.NAME}" placeholder="50字以内…">
                ...
                <c:if test="${type==4}">
                	...
                	<div class="widget-body">
	                  ...
	                  <div class="control-group">
	                    ...
	                    <div class="controls">
	                      <input class="span5" type="text" name="NAME" value="${chapter2.NAME}" placeholder="50字以内…">
    ...
    <script type="text/javascript">
    	...
    	function phase(obj){
    		$.post("book/search_phase",{"course_id":$(obj).val()},function(phase){
    	...
    	function chapter(obj){
    		$.post("book/search_chapter1",{"phase_id":$(obj).val()},function(chapter1){
