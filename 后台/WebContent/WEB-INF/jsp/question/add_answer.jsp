            ...
            <div class="widget-body">
              <div class="widget-forms clearfix">
                  ...
                  <c:if test="${question_type.id==3}">
	                    ...
	                    <div class="controls">
	                      <label class="radio">
	                        <input type="radio" name="answer" value="Y" checked>
	                        	正确
	                      </label> 
	                      <label class="radio">
